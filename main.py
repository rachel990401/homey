...
paid expenses, and custom lists from one shared workspace. The web interface is
used for the polished demo, while the terminal version shows the same Python
logic through input() and print().
...
PROGRAM FLOW:
    ...
    5. Data is saved after changes and returned to the web or terminal view
...
ADVANCED CONCEPTS USED:
    ...
    - Loops         : setup prompts, menu flow, filtering, summaries, calendar
    - Break/continue: terminal menus, validation flow, and settlement matching
...
def terminal_setup() -> None:
    """
    Run the setup flow for the terminal version.
